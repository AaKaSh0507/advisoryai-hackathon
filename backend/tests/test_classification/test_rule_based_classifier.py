"""
Tests for rule-based section classification.

Verifies:
- Obvious STATIC sections are classified without LLM usage
- Obvious DYNAMIC candidates are flagged correctly
- Rule-based decisions are deterministic
- High-confidence rule decisions maintain expected thresholds
- Edge cases with ambiguous but rule-covered structures
"""
...
class TestRuleBasedClassifierInitialization:
    """Tests for rule-based classifier setup."""

    def test_classifier_is_importable(self):
        """Rule-based classifier should be importable."""
        classifier = RuleBasedClassifier()
        assert classifier is not None

    def test_classifier_has_default_confidence_threshold(self):
        """Classifier should have default confidence threshold."""
        classifier = RuleBasedClassifier()
...
class TestStaticPatternClassification:
    """Tests for STATIC pattern recognition."""

    @pytest.fixture
    def classifier(self):
        """Create classifier with default threshold."""
        return RuleBasedClassifier(confidence_threshold=0.85)

    def test_legal_disclaimer_classified_as_static(self, classifier):
        """Legal disclaimers should be classified as STATIC with high confidence."""
    ...
    def test_copyright_notice_classified_as_static(self, classifier):
        """Copyright notices should be classified as STATIC."""
        block = ParagraphBlock(
    ...
    def test_boilerplate_text_classified_as_static(self, classifier):
        """Boilerplate text should be classified as STATIC."""
        block = ParagraphBlock(
    ...
    def test_contact_information_classified_as_static(self, classifier):
        """Contact information should be classified as STATIC."""
        block = ParagraphBlock(
    ...
    def test_page_number_classified_as_static(self, classifier):
        """Page number references should be classified as STATIC."""
        block = ParagraphBlock(
    ...
    def test_internal_use_only_classified_as_static(self, classifier):
        """'Internal use only' markers should be classified as STATIC."""
        block = ParagraphBlock(
...
class TestDynamicPatternClassification:
    """Tests for DYNAMIC pattern recognition."""
    ...
    def test_placeholder_curly_braces_classified_as_dynamic(self, classifier):
        """Placeholders with curly braces should be classified as DYNAMIC."""
        block = ParagraphBlock(
    ...
    def test_placeholder_square_brackets_classified_as_dynamic(self, classifier):
        """Placeholders with square brackets should be classified as DYNAMIC."""
        block = ParagraphBlock(
    ...
    def test_placeholder_angle_brackets_classified_as_dynamic(self, classifier):
        """Placeholders with angle brackets should be classified as DYNAMIC."""
        block = ParagraphBlock(
    ...
    def test_explicit_customization_marker_classified_as_dynamic(self, classifier):
        """Explicit customization markers should be classified as DYNAMIC."""
        block = ParagraphBlock(
    ...
    def test_client_specific_reference_classified_as_dynamic(self, classifier):
        """Client-specific references should be classified as DYNAMIC."""
        block = ParagraphBlock(
    ...
    def test_narrative_recommendation_classified_as_dynamic(self, classifier):
        """Narrative recommendations should be classified as DYNAMIC."""
        block = ParagraphBlock(
...
class TestStructuralIndicatorClassification:
    """Tests for structural indicator classification."""
    ...
    def test_header_block_classified_as_static(self, classifier):
        """Header blocks should be classified as STATIC."""
    ...
    def test_footer_block_classified_as_static(self, classifier):
        """Footer blocks should be classified as STATIC."""
        block = HeaderFooterBlock(
    ...
    def test_level_one_heading_classified_as_static(self, classifier):
        """Level 1 headings should be classified as STATIC."""
        block = HeadingBlock(
...
class TestContentHeuristicClassification:
    """Tests for content-based heuristic classification."""

    @pytest.fixture
    def classifier(self):
        """Create classifier with lower threshold for heuristics."""
        return RuleBasedClassifier(confidence_threshold=0.70)

    def test_very_short_content_classified_as_static(self, classifier):
        """Very short static labels should be classified as STATIC."""
        block = ParagraphBlock(
        ...
        # "Proprietary" should match as internal use pattern
        assert result is not None
        assert result.section_type == "STATIC"

    def test_all_caps_short_text_classified_as_static(self, classifier):
        """ALL CAPS short text should be classified as STATIC."""
        block = ParagraphBlock(
    ...
    def test_long_narrative_classified_as_dynamic(self, classifier):
        """Long narrative paragraphs should be classified as DYNAMIC."""
        long_text = (
...
class TestClassificationDeterminism:
    ...
    @pytest.fixture
    def classifier(self):
        """Create classifier for determinism tests."""
        return RuleBasedClassifier(confidence_threshold=0.85)

    def test_same_input_produces_identical_results(self, classifier):
        """Same input should always produce identical classification results."""
        block = ParagraphBlock(
    ...
    def test_different_blocks_same_content_consistent(self, classifier):
        """Different blocks with same content should have consistent classification."""
...
class TestNoMatchReturnsNone:
    """Tests for cases where no confident classification is possible."""
    ...
    def test_ambiguous_content_returns_none(self, classifier):
        """Ambiguous content should return None for rule-based classification."""
        block = ParagraphBlock(
        ...
        # Ambiguous content should not be confidently classified by rules
        # It should either return None or have low confidence
        if result is not None:
            assert result.confidence_score < 0.90

    def test_generic_paragraph_not_confidently_classified(self, classifier):
        """Generic paragraphs should not be confidently classified by rules."""
        block = ParagraphBlock(
        ...
        # Generic text should not match high-confidence patterns
        if result is not None:
            assert result.confidence_score < 0.90
...
class TestConfidenceLevels:
    ...
    def test_high_confidence_level_assignment(self, classifier):
        """Confidence >= 0.9 should be HIGH level."""
        block = ParagraphBlock(
    ...
    def test_medium_confidence_level_assignment(self, classifier):
        """Confidence >= 0.7 and < 0.9 should be MEDIUM level."""
        # Use a pattern that gives medium confidence
        block = ParagraphBlock(
            block_id="blk_par_0051_xyz",
            sequence=51,
            runs=[TextRun(text="APPENDIX")],  # ALL CAPS short text = 0.80 confidence
        )
    ...
    def test_classification_result_has_justification(self, classifier):
        """All classification results should have justification."""
        block = ParagraphBlock(
    ...
    def test_classification_result_has_metadata(self, classifier):
        """Classification results should have metadata."""
        block = ParagraphBlock(
