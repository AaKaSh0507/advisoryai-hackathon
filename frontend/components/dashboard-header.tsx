      ...
      <div className="flex items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <h2 className="text-base sm:text-lg font-semibold text-foreground truncate">Template Intelligence Engine</h2>
            <p className="text-xs sm:text-sm text-muted-foreground hidden sm:block">Automated Word template processing with AI</p>
          </div>
        </div>
        <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
          <div className="hidden lg:flex items-center gap-2 rounded-lg border border-border px-3 py-2">
          ...
          <div className="h-8 w-8 flex-shrink-0 rounded-full bg-gradient-to-br from-primary to-accent" />
        </div>
      </div>
    </header>
  )
